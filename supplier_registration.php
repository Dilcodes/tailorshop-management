...
<html lang="en">
    ...
    <body class="hold-transition sidebar-mini">
            ...
            <div class="content-wrapper">
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title">Supplier Registration Form</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="row">
                        <div class="col-md-5">
                            ...
                            <form class="form-horizontal">
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-3 col-form-label">Supplier Name:<span class="text-danger"> *</span></label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" required id="sname">
                                            <h6 style="color: red" id="sname_msg" class="d-none">This field is required</h6>
                                        </div>
                                    </div>                                  
                                    <div class="form-group row">
                        ...
                        <div class="col-md-7">
                            ...
                            <table class="table table-bordered table-striped table-hover" id="supplier_tbl">
        ...
        <script type="text/javascript" src="./controller/supplier_registration_controller.js"></script>
    </body>
</html>
