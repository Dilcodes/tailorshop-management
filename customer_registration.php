...
<html lang="en">
    ...
    <body class="hold-transition sidebar-mini">
                ...
                <div class="card card-info">
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            ...
                            <form class="form-horizontal">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label for="nic" class="col-sm-3 col-form-label">NIC : <br><span class="text-danger">(optional)</span></label>
                                        <div class="col-sm-9">
                                ...
                                <div class="card-footer">
                                    ...
                                    <a type="button" href="./?location=new_order" class="btn btn-dark" id="add_new">Add New Order</a>
                                </div>
                                <!-- /.card-footer -->
                            </form>
                        </div>
                        <div class="col-md-7">
                            ...
                            <table class="table table-bordered table-striped table-hover" id="customer_tbl">
        ...
        <script type="text/javascript" src="./controller/customer_registration_controller.js"></script>
    </body>
</html>
